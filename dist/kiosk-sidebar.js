 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(e,t,o,i){const n=t[0];if("."===n){return new E(e,t.slice(1),o).parts}if("@"===n)return[new q(e,t.slice(1),i.eventContext)];if("?"===n)return[new k(e,t.slice(1),o)];return new x(e,t,o).parts}handleTextExpression(e){return new P(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
