 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(e,t,o,n){const i=t[0];if("."===i){return new k(e,t.slice(1),o).parts}if("@"===i)return[new q(e,t.slice(1),n.eventContext)];if("?"===i)return[new P(e,t.slice(1),o)];return new x(e,t,o).parts}handleTextExpression(e){return new E(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
